...
export default function App() {
  ...
  const transplantToPond = (pondIndex) => {
    try {
      ...
      //console.log(sourceTray.ready(day));

      if (sourceTray.ready(day)) {
  ...
  const varietiesButtons = varieties.map((variety) => {
    return (
      <button className="btn btn-primary" onClick={() => seedTray(variety)}>
        {variety.name}
      </button>
    );
  });
  ...
  return (
    <div className="App">
      ...
      <div className="container mb-4">
        <div className="row">
          <div className="col">{varietiesButtons}</div>
        </div>
        <div className="row">
          <div className="col">
            <div
